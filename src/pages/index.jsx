      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            {"I'm"} Samad, a software engineer based in Karachi City.
            I have a passion for building user-friendly products.
            Very passionate about solving complex problems in diverse settings and very enthusiastic about quickly learning new tools and technologies.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/abdsamadf"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://linkedin.com/in/samad-farooq"
